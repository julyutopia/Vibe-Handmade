...
- (UIFont *)font {
    ...
    _font =  [UIFont fontWithName:Default_Font size:14];
    return _font;
}
...
- (UIColor *)textColor {
    ...
    if (_style == YUSegmentStyleBox) {
        ...
        _textColor = DefaultQYTextColor50;
    }
    return _textColor;
}
...
- (UIFont *)selectedFont {
    ...
    _selectedFont = [UIFont fontWithName:Default_Font size:16];
    return _selectedFont;
}
...
- (UIColor *)selectedTextColor {
    ...
    if (_style == YUSegmentStyleBox) {
        ...
        _selectedTextColor = DefaultQYTextColor90;
    }
    return _selectedTextColor;
}
