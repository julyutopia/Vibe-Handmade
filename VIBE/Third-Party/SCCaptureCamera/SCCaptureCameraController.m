...
- (void)addTopView{
    if (!_topContainerView) {
        ...
        emptyView.backgroundColor = bottomContainerView_UP_COLOR;
        [_topContainerView addSubview:emptyView];
        
        UIImageView *logoImgView = [[UIImageView alloc]initWithFrame:CGRectMake((topFrame.size.width -44)/2,(topFrame.size.height -30)/2, 44, 30)];
        [logoImgView setAlpha:0.9];
        [logoImgView setImage:[UIImage imageNamed:@"logo_W"]];
        [_topContainerView addSubview:logoImgView];
    }
}
