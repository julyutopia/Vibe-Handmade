//
//  CreatorDetailMorePhotosTableViewCell.m
//  VIBE
//
...
@implementation CreatorDetailMorePhotosTableViewCell
...
-(void)tapStoryDetailPhotoView:(GLImageView *)photoImgView
{
    ...
    if ([_delegate respondsToSelector:@selector(creatorDetailPhotoTableViewShowImages:WithIndex:)]) {
        [_delegate creatorDetailPhotoTableViewShowImages:_morePhotosArray WithIndex:index];
    }
}
