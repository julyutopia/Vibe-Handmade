//
//  SearchProductsHeaderTableViewCell.m
//  VIBE
//
...
@implementation SearchProductsHeaderTableViewCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        _titleImgView = [[UIImageView alloc]initWithFrame:CGRectMake( (kScreenWidth -20 -95)/2, 13, 95, 19)];
        [_titleImgView setImage:[UIImage imageNamed:@"Search_Result_Products"]];
