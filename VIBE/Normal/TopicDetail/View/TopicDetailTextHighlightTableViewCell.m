...
-(void)setTopicDetailTextHighlightCellWithInfo:(NSString *)detail
{
    ...
    if (hightlightTextHeight >20) {
        ...
        hightlightTextHeight = [[VibeAppTool sharedInstance]getSpaceLabelHeight:hightlightText withFont:_highlightTextLabel.font withWidth:hightlightTextWidth withLineSpacing:4.0];
    }
    else{
