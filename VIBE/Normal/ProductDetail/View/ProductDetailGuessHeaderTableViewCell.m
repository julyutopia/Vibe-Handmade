...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {        
        _backView = [[UIView alloc]initWithFrame:CGRectMake(20, 0, kScreenWidth -40,15 +15 +16 +10)];
        [_backView setBackgroundColor:[UIColor clearColor]];
        [self addSubview:_backView];
        
        
        _headerView = [[UIView alloc]initWithFrame:CGRectMake(0, 15, kScreenWidth -40, 15 +16 +10)];
