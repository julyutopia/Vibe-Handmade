//
//  ProductDetailGuessProductTableViewCell.m
//  VIBE
//
...
@implementation ProductDetailGuessProductTableViewCell
...
-(void)setGuessProductWithModal:(VibeProductModal *)modal IsLast:(BOOL )last
{
    ...
    [_favorCountLabel setFrame:CGRectMake(kScreenWidth -40 -10 -favorWidth, 10 +_imageViewHeight -15, favorWidth, 15)];
